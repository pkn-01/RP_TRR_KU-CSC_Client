  ...
  const handleExportExcel = () => {
    ...
    try {
      ...
      const dataToExport =
        exportLimit === "all"
          ? filteredRepairs
          : filteredRepairs.slice(0, exportLimit);
      ...
      <div className="max-w-[1400px] mx-auto space-y-6">
        ...
        <div className="flex flex-col md:flex-row gap-3 items-start md:items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-0 border border-gray-300 rounded-lg bg-white overflow-hidden text-sm">
              <select
                value={exportLimit}
                onChange={(e) =>
                  setExportLimit(
                ...
                className="pl-3 pr-8 py-2 bg-transparent text-gray-700 outline-none border-r border-gray-300 cursor-pointer hover:bg-gray-50 focus:bg-gray-50 appearance-none"
                style={{
              ...
              <button
                ...
                className="px-4 py-2 bg-white text-gray-700 hover:bg-gray-50 font-medium flex items-center gap-2 transition-colors"
              >
