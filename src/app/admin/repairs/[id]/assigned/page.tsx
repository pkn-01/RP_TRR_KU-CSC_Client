...
const statusLabels = {
  OPEN: { label: 'เปิด', color: 'bg-yellow-100 text-yellow-800', bgColor: 'bg-yellow-50' },
  IN_PROGRESS: { label: 'กำลังดำเนินการ', color: 'bg-blue-100 text-blue-800', bgColor: 'bg-blue-50' },
  DONE: { label: 'เสร็จสิ้น', color: 'bg-green-100 text-green-800', bgColor: 'bg-green-50' },
};
...
export default function AssignRepairPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const errorMessage = err instanceof Error ? err.message : 'ไม่สามารถดึงข้อมูลได้';
  ...
  const handleAssign = async () => {
    ...
    try {
      ...
      const errorMessage = err instanceof Error ? err.message : 'ไม่สามารถมอบหมายงานได้';
      setError(errorMessage);
    } finally {
      setSaving(false);
  ...
  const selectedTechnicianInfo = technicians.find(t => t.id === selectedTechnician);
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-xl font-bold text-gray-900 mb-6">รายละเอียดงานซ่อม</h2>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-4 pb-4 border-b border-gray-200">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-lg font-semibold text-gray-900 mt-1">{repair.ticketCode}</p>
                </div>
              </div>

              {/* Title */}
              <div className="flex items-start gap-4 pb-4 border-b border-gray-200">
                <FileText size={20} className="text-orange-600 flex-shrink-0 mt-1" />
                <div className="flex-1">
                  <p className="text-sm text-gray-600 font-medium">ชื่อเรื่อง</p>
                  <p className="text-lg font-semibold text-gray-900 mt-1">{repair.title}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 pb-4 border-b border-gray-200">
                ...
                <div className="flex-1">
                  <p className="text-sm text-gray-600 font-medium mb-2">คำอธิบาย</p>
              ...
              {/* Equipment */}
              <div className="flex items-start gap-4 pb-4 border-b border-gray-200">
                <Wrench size={20} className="text-purple-600 flex-shrink-0 mt-1" />
                <div className="flex-1">
                  <p className="text-sm text-gray-600 font-medium">อุปกรณ์</p>
                  <p className="text-lg font-semibold text-gray-900 mt-1">{repair.equipmentName}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 pb-4 border-b border-gray-200">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-lg font-semibold text-gray-900 mt-1">{repair.location || 'ไม่ระบุ'}</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 pt-2">
                <div className="flex items-center gap-3 bg-gradient-to-br from-red-50 to-orange-50 p-4 rounded-lg border border-red-100">
                  <div className="flex-1">
                    <p className="text-xs text-gray-600 font-medium mb-1">ความสำคัญ</p>
                    <span className={`inline-flex px-3 py-1 rounded-full text-sm font-semibold ${priorityLabels[repair.priority].color}`}>
                ...
                <div className="flex items-center gap-3 bg-gradient-to-br from-yellow-50 to-amber-50 p-4 rounded-lg border border-yellow-100">
                  <div className="flex-1">
                    <p className="text-xs text-gray-600 font-medium mb-1">สถานะ</p>
                    <span className={`inline-flex px-3 py-1 rounded-full text-sm font-semibold ${statusLabels[repair.status].color}`}>
                ...
                <>
                  ...
                  <div className="flex items-center gap-4 pb-4 border-b border-gray-200">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-lg font-semibold text-gray-900 mt-1">{repair.user.name}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 pb-4 border-b border-gray-200">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-900 mt-1 break-all">{repair.user.email}</p>
                    </div>
                  </div>
                  ...
                  {repair.user.phone && (
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-gray-900 mt-1">{repair.user.phone}</p>
                      </div>
                    </div>
                  )}
                </>
        ...
        <div className="lg:col-span-1 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                {technicians.length > 0 ? (
                  ...
                  <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 text-center">
                    ...
                    <p className="text-sm text-yellow-800">ไม่มีข้อมูลผู้เชี่ยวชาญ</p>
                  </div>
                )}
              </div>
              ...
              {selectedTechnicianInfo && (
                <div className="bg-white rounded-lg p-4 border-l-4 border-green-500">
                  <p className="text-xs text-gray-600 font-medium mb-2">ผู้รับผิดชอบที่เลือก</p>
                  <p className="font-bold text-gray-900">{selectedTechnicianInfo.name}</p>
                  <p className="text-sm text-gray-600 mt-1">{selectedTechnicianInfo.email}</p>
                </div>
              )}
              ...
              {showConfirm ? (
                <div className="bg-blue-50 border-2 border-blue-300 rounded-lg p-4 space-y-3">
                  <p className="text-sm font-semibold text-gray-900">
                    ยืนยันการมอบหมายงานให้ <span className="text-blue-600">{selectedTechnicianInfo?.name}</span>?
                  </p>
          ...
          <div className="bg-blue-50 rounded-lg p-6 border border-blue-200">
            <h3 className="font-bold text-gray-900 mb-3 text-sm">💡 เคล็ดลับ</h3>
